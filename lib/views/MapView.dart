...
class _MapViewState extends State<MapView> {
                    ...
                    child: Column(
                      children: [
                        ...
                        if (selectedPackage != null)
                          CustomStyles.packagesAssignCard(
                              context,
                          ...
                          ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              ...
                              return CustomStyles.packagesAssignCard(
                                  context,
                                  PackagesAssignController(
                                      baseUrl:
                                          widget.packagesController.baseUrl),
                                  package);
                            },
                          ),
                      ],
  ...
  Future<List<DeliveryPackageModel>> _getPackagesWithCoordinates() async {
    List<DeliveryPackageModel> packages =
        await widget.packagesController.notStartedPackages();
    for (var package in packages) {
      ...
      LatLng startCoordinates = await widget.geocoding
          .getLatLngFromAddress(jsonEncode(startLocationJson));
      ...
      LatLng endCoordinates = await widget.geocoding
          .getLatLngFromAddress(jsonEncode(endLocationJson));
